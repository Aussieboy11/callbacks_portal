...
callbackee = Callbackee(first_name='Yacob', last_name='Yonas',
						net_id='yyonas', decisions_made=False, email_sent=False)
callbackee.save()
group = Group.objects.get(name='Old NasSoul')

callback = Callbacks(callbackee=callbackee, group=group, accepted=None)
callback.save()